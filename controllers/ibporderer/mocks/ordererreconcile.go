...
type OrdererReconcile struct {
	ReconcileStub        func(*v1beta1.IBPOrderer, baseorderer.Update) (common.Result, error)
	reconcileMutex       sync.RWMutex
	reconcileArgsForCall []struct {
		arg1 *v1beta1.IBPOrderer
		arg2 baseorderer.Update
	}
...
func (fake *OrdererReconcile) Reconcile(arg1 *v1beta1.IBPOrderer, arg2 baseorderer.Update) (common.Result, error) {
...
func (fake *OrdererReconcile) ReconcileCallCount() int {
	fake.reconcileMutex.RLock()
	defer fake.reconcileMutex.RUnlock()
	return len(fake.reconcileArgsForCall)
}

func (fake *OrdererReconcile) ReconcileCalls(stub func(*v1beta1.IBPOrderer, baseorderer.Update) (common.Result, error)) {
	fake.reconcileMutex.Lock()
	defer fake.reconcileMutex.Unlock()
	fake.ReconcileStub = stub
}

func (fake *OrdererReconcile) ReconcileArgsForCall(i int) (*v1beta1.IBPOrderer, baseorderer.Update) {
	fake.reconcileMutex.RLock()
	defer fake.reconcileMutex.RUnlock()
...
func (fake *OrdererReconcile) ReconcileReturns(result1 common.Result, result2 error) {
	fake.reconcileMutex.Lock()
	defer fake.reconcileMutex.Unlock()
...
func (fake *OrdererReconcile) ReconcileReturnsOnCall(i int, result1 common.Result, result2 error) {
	fake.reconcileMutex.Lock()
	defer fake.reconcileMutex.Unlock()
	fake.ReconcileStub = nil
...
func (fake *OrdererReconcile) Invocations() map[string][][]interface{} {
...
func (fake *OrdererReconcile) recordInvocation(key string, args []interface{}) {
