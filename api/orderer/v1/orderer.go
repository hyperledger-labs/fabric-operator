...
type Cluster struct {
	...
	RPCTimeout                           common.Duration `json:"rpcTimeout,omitempty"`
	ReplicationBufferSize                int             `json:"replicationBufferSize,omitempty"`
	ReplicationPullTimeout               common.Duration `json:"replicationPullTimeout,omitempty"`
	ReplicationRetryTimeout              common.Duration `json:"replicationRetryTimeout,omitempty"`
	ReplicationBackgroundRefreshInterval common.Duration `json:"replicationBackgroundRefreshInterval,omitempty"`
	ReplicationMaxRetries                int             `json:"replicationMaxRetries,omitempty"`
	SendBufferSize                       int             `json:"sendBufferSize,omitempty"`
	CertExpirationWarningThreshold       common.Duration `json:"certExpirationWarningThreshold,omitempty"`
	TLSHandshakeTimeShift                common.Duration `json:"tlsHandshakeTimeShift,omitempty"`
}

// Keepalive contains configuration for gRPC servers.
type Keepalive struct {
	ServerMinInterval common.Duration `json:"serverMinInterval,omitempty"`
	ServerInterval    common.Duration `json:"serverInterval,omitempty"`
	ServerTimeout     common.Duration `json:"serverTimeout,omitempty"`
}
...
// leader election).
type Retry struct {
	ShortInterval   common.Duration `json:"shortInterval,omitempty"`
	ShortTotal      common.Duration `json:"shortTotal,omitempty"`
	LongInterval    common.Duration `json:"longInterval,omitempty"`
	LongTotal       common.Duration `json:"longTotal,omitempty"`
...
type NetworkTimeouts struct {
	DialTimeout  common.Duration `json:"dialTimeout,omitempty"`
	ReadTimeout  common.Duration `json:"readTimeout,omitempty"`
	WriteTimeout common.Duration `json:"writeTimeout,omitempty"`
}
...
type Metadata struct {
	...
	RetryBackoff common.Duration `json:"retryBackoff,omitempty"`
}
