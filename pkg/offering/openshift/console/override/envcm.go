...
func (o *Override) CreateCM(instance *current.IBPConsole, cm *corev1.ConfigMap) error {
	cm.Data["HOST_URL"] = fmt.Sprintf("https://%s-%s-console.%s:443", instance.GetNamespace(), instance.GetName(), instance.Spec.NetworkInfo.Domain)
	cm.Data["HOST_URL_WS"] = fmt.Sprintf("https://%s-%s-console.%s:443", instance.GetNamespace(), instance.GetName(), instance.Spec.NetworkInfo.Domain)
