...
func (o *Override) CreateIngress(instance *current.IBPCA, ingress *networkingv1.Ingress) error {
	return o.CommonIngress(instance, ingress)
}

func (o *Override) UpdateIngress(instance *current.IBPCA, ingress *networkingv1.Ingress) error {
	return o.CommonIngress(instance, ingress)
}

func (o *Override) CommonIngress(instance *current.IBPCA, ingress *networkingv1.Ingress) error {
