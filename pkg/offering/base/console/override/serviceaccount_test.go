...
var _ = Describe("Base Service Account Overrides", func() {
	var (
	...
	BeforeEach(func() {
		...
		sa, err = util.GetServiceAccountFromFile("../../../../../definitions/console/serviceaccount.yaml")
	...
	Context("create", func() {
		It("overrides values in service account, based on Console's instance spec", func() {
			...
			By("setting the image pull secret", func() {
				...
				Expect(sa.ImagePullSecrets[2].Name).To(Equal(instance.Spec.ImagePullSecrets[1]))
			})
		})
