...
func (o *Override) CreateService(instance *current.IBPConsole, service *corev1.Service) error {
	err := o.CommonServiceOverride(instance, service)
	if err != nil {
		return err
	}

	consolePort := instance.Spec.NetworkInfo.ConsolePort
	if consolePort != 0 && instance.Spec.Service != nil && instance.Spec.Service.Type == corev1.ServiceTypeNodePort {
		service.Spec.Ports[0].NodePort = consolePort
	}
