...
type DeploymentReset struct {
	DeploymentStatusStub        func(v1a.Object) (v1.DeploymentStatus, error)
	deploymentStatusMutex       sync.RWMutex
	deploymentStatusArgsForCall []struct {
		arg1 v1a.Object
	}
	deploymentStatusReturns struct {
		result1 v1.DeploymentStatus
		result2 error
	}
	...
	GetStub        func(v1a.Object) (client.Object, error)
...
func (fake *DeploymentReset) DeploymentStatus(arg1 v1a.Object) (v1.DeploymentStatus, error) {
...
func (fake *DeploymentReset) DeploymentStatusCallCount() int {
	fake.deploymentStatusMutex.RLock()
	defer fake.deploymentStatusMutex.RUnlock()
	return len(fake.deploymentStatusArgsForCall)
}

func (fake *DeploymentReset) DeploymentStatusCalls(stub func(v1a.Object) (v1.DeploymentStatus, error)) {
	fake.deploymentStatusMutex.Lock()
	defer fake.deploymentStatusMutex.Unlock()
	fake.DeploymentStatusStub = stub
}

func (fake *DeploymentReset) DeploymentStatusArgsForCall(i int) v1a.Object {
	fake.deploymentStatusMutex.RLock()
	defer fake.deploymentStatusMutex.RUnlock()
...
func (fake *DeploymentReset) DeploymentStatusReturns(result1 v1.DeploymentStatus, result2 error) {
	fake.deploymentStatusMutex.Lock()
	defer fake.deploymentStatusMutex.Unlock()
...
func (fake *DeploymentReset) DeploymentStatusReturnsOnCall(i int, result1 v1.DeploymentStatus, result2 error) {
	fake.deploymentStatusMutex.Lock()
	defer fake.deploymentStatusMutex.Unlock()
	fake.DeploymentStatusStub = nil
...
func (fake *DeploymentReset) Get(arg1 v1a.Object) (client.Object, error) {
	fake.getMutex.Lock()
...
func (fake *DeploymentReset) GetCallCount() int {
	fake.getMutex.RLock()
	defer fake.getMutex.RUnlock()
	return len(fake.getArgsForCall)
}

func (fake *DeploymentReset) GetCalls(stub func(v1a.Object) (client.Object, error)) {
	fake.getMutex.Lock()
	defer fake.getMutex.Unlock()
	fake.GetStub = stub
}

func (fake *DeploymentReset) GetArgsForCall(i int) v1a.Object {
	fake.getMutex.RLock()
	defer fake.getMutex.RUnlock()
...
func (fake *DeploymentReset) GetReturns(result1 client.Object, result2 error) {
	fake.getMutex.Lock()
	defer fake.getMutex.Unlock()
	fake.GetStub = nil
...
func (fake *DeploymentReset) GetReturnsOnCall(i int, result1 client.Object, result2 error) {
	fake.getMutex.Lock()
	defer fake.getMutex.Unlock()
	fake.GetStub = nil
...
func (fake *DeploymentReset) GetScheme() *runtime.Scheme {
...
func (fake *DeploymentReset) GetSchemeCallCount() int {
	fake.getSchemeMutex.RLock()
	defer fake.getSchemeMutex.RUnlock()
	return len(fake.getSchemeArgsForCall)
}

func (fake *DeploymentReset) GetSchemeCalls(stub func() *runtime.Scheme) {
	fake.getSchemeMutex.Lock()
	defer fake.getSchemeMutex.Unlock()
	fake.GetSchemeStub = stub
}

func (fake *DeploymentReset) GetSchemeReturns(result1 *runtime.Scheme) {
	fake.getSchemeMutex.Lock()
	defer fake.getSchemeMutex.Unlock()
...
func (fake *DeploymentReset) GetSchemeReturnsOnCall(i int, result1 *runtime.Scheme) {
	fake.getSchemeMutex.Lock()
	defer fake.getSchemeMutex.Unlock()
	fake.GetSchemeStub = nil
...
func (fake *DeploymentReset) Invocations() map[string][][]interface{} {
...
func (fake *DeploymentReset) recordInvocation(key string, args []interface{}) {
...
var _ action.DeploymentReset = new(DeploymentReset)
