...
func (fake *Instance) EnrollerImage() string {
...
func (fake *Instance) EnrollerImageReturnsOnCall(i int, result1 string) {
	fake.enrollerImageMutex.Lock()
	defer fake.enrollerImageMutex.Unlock()
	fake.EnrollerImageStub = nil
...
func (fake *Instance) GetPullSecrets() []v1a.LocalObjectReference {
...
func (fake *Instance) GetPullSecretsCallCount() int {
	fake.getPullSecretsMutex.RLock()
	defer fake.getPullSecretsMutex.RUnlock()
	return len(fake.getPullSecretsArgsForCall)
}

func (fake *Instance) GetPullSecretsCalls(stub func() []v1a.LocalObjectReference) {
	fake.getPullSecretsMutex.Lock()
	defer fake.getPullSecretsMutex.Unlock()
	fake.GetPullSecretsStub = stub
}

func (fake *Instance) GetPullSecretsReturns(result1 []v1a.LocalObjectReference) {
	fake.getPullSecretsMutex.Lock()
	defer fake.getPullSecretsMutex.Unlock()
...
func (fake *Instance) GetPullSecretsReturnsOnCall(i int, result1 []v1a.LocalObjectReference) {
	fake.getPullSecretsMutex.Lock()
	defer fake.getPullSecretsMutex.Unlock()
	fake.GetPullSecretsStub = nil
...
func (fake *Instance) GetResource(arg1 v1beta1.Component) v1a.ResourceRequirements {
...
func (fake *Instance) GetResourceCallCount() int {
	fake.getResourceMutex.RLock()
	defer fake.getResourceMutex.RUnlock()
	return len(fake.getResourceArgsForCall)
}

func (fake *Instance) GetResourceCalls(stub func(v1beta1.Component) v1a.ResourceRequirements) {
	fake.getResourceMutex.Lock()
	defer fake.getResourceMutex.Unlock()
	fake.GetResourceStub = stub
}

func (fake *Instance) GetResourceArgsForCall(i int) v1beta1.Component {
	fake.getResourceMutex.RLock()
	defer fake.getResourceMutex.RUnlock()
...
func (fake *Instance) GetResourceReturns(result1 v1a.ResourceRequirements) {
	fake.getResourceMutex.Lock()
	defer fake.getResourceMutex.Unlock()
...
func (fake *Instance) GetResourceReturnsOnCall(i int, result1 v1a.ResourceRequirements) {
	fake.getResourceMutex.Lock()
	defer fake.getResourceMutex.Unlock()
	fake.GetResourceStub = nil
...
func (fake *Instance) PVCName() string {
...
func (fake *Instance) PVCNameReturnsOnCall(i int, result1 string) {
	fake.pVCNameMutex.Lock()
	defer fake.pVCNameMutex.Unlock()
	fake.PVCNameStub = nil
...
var _ enroller.Instance = new(Instance)
