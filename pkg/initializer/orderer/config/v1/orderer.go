...
func (o *Orderer) SetDefaultKeyStore() {
	if o.General.BCCSP.PKCS11 != nil {
		o.General.BCCSP.PKCS11.FileKeyStore = &commonapi.FileKeyStoreOpts{
...
func (o *Orderer) SetBCCSPLibrary(library string) {
	if o.General.BCCSP.PKCS11 == nil {
		o.General.BCCSP.PKCS11 = &common.PKCS11Opts{}
	}
...
type OrdererOverrides struct {
	// Not Fabric - this is for deployment
	MaxNameLength *int `json:"maxnamelength,omitempty"`
}

func (o *OrdererOverrides) GetMaxNameLength() *int {
	return o.MaxNameLength
}

func (o *OrdererOverrides) DeepCopyInto(into *OrdererOverrides) {
	b, err := json.Marshal(o)
	if err != nil {
		return
	}
...
func (o *OrdererOverrides) DeepCopy() *OrdererOverrides {
	if o == nil {
		return nil
	}
	out := new(OrdererOverrides)
	o.DeepCopyInto(out)
	return out
}
